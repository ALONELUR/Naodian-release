...
N_brain=2*960/x_center;%大脑纹理缩小倍数
...
%         Screen('DrawText',window,double('左'),pointlist(5,1,4)+text_size*0.2,pointlist(5,2,4),255);
        Screen('DrawText',window,double('加速'),Center(5,1)-text_size*1.7,plus_position(8,2)+text_size*0.5,255);
        Screen('DrawText',window,double('减速'),Center(6,1)-text_size*1.7,minus_position(3,2)-text_size*4,255);
        Screen('DrawText',window,double('鸣笛'),Center(7,1)-text_size*1.7,whistle_position(4),255);
        Screen('DrawText',window,double('停车'),Center(8,1)-text_size*1.7,stopbutton_position(2,2)-text_size*1.7,255);
